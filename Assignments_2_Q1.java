...
import java.util.*;
class  Assignment_2_Q1 {


 
 /**
   * receing  the  value  and  its  power
   * caculation  of  power  to  the  value  for  inter  conversion  of  decimal  and  octal
  */
 ...
 public static int power( int n , int p )
  ...
  /**
   * accepting  the  two  string 
   * converting  these  strings  from  hexa  to  decimal 
   * converting  the  string  to  in teger from  string
   * performing  computation  and  return  the  string  value
   */
  ...
  public static int divide(String str1 , String str2 )
   {
      str1 = Hex_to_Decimal(str1);
      str2 = Hex_to_Decimal(str2);
  ...
  /**
   * accepting  the  two  string 
   * firstly  checking  the  string  by  length  return  the  comparison  on  length
   * if  string  is  of  equal  length then check  the  string  place  value  characters 
     and  return  accordingly  1 , -1 
   */
   ...
   * converting  the  int decimal  to hexa and  returns  the  string 
   * if remainder  > 9 then  add 55 to  it  and  convert  it  to  asci character
   * other wise  just  convert  it  ot  ots  asci  character
   */
 ...
 /**
   * receiving  the  integer 
   * multiply  each  charac  of  string  with  the  increasing  power  of  hexa  16
   * concatinating  the  string &  return  it
   */
 ...
 /**
   * accepting  the  two  hexa  string 
   * assigning  the  type  casting  value  to  the  char
   * if  value  is  greater  thean  9 then  add 55 to  it  and  convert  it  ot  its  asci  value
   */
